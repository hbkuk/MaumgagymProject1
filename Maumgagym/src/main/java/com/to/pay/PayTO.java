...
public class PayTO {
	...
	int payment_detail_status; 			// 결제 상세 내역 상태 ==> 1: 완료 , 2: 실패, 3: 환불, 헷갈릴경우 TO 클래스 분할
	String register_date;				// 등록일
	String expiry_date;					// 만료일
	int membership_register_status;		// 회원권 상태 ==> 1: 승인 대기, 2: 정상, 3: 홀딩, 4: 만료
